  ...
  Widget build(BuildContext context) {
      ...
      return CustomScaffold(
         ...
         child:  // Text('Sign IN'),
              ...
              flex: 7,    // to divide the parts by scale
                         ...
                         child: Container(
                          ...
                          padding:  const EdgeInsets.fromLTRB(25.0, 50.0, 25.0, 20.0),
                           ...
                           decoration:  const BoxDecoration(
                             ...
                             child: SingleChildScrollView(       // to scroll up and down
                               child: Form(
                                ...
                                color: Colors.black12, // Default border color
                                                     ...
                                                     const SizedBox(height: 25.0),
                                                     Row(
                                                        mainAxisAlignment: MainAxisAlignment.spaceBetween,    // to separate Remember me and Forget password
                                                       children: [
                                                           Row(
                                   children: [
                                        Checkbox(
